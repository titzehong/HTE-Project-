...
\begin{figure}[H]
  ...
  \caption{Various regression diagnostic plots. Left: Y True vs Y Predicted. Middle: Histogram of mean residuals. Right: Scatter plot of mean residual vs Y True}
